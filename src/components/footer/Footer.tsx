import "@rhds/elements/rh-footer/rh-footer"
import "@rhds/elements/rh-footer/rh-footer-lightdom.css"
// import "@rhds/elements/rh-cta/rh-cta"
...
declare global {
  ...
  namespace JSX {
    interface IntrinsicElements {
      ['rh-footer']: unknown;
      ['rh-footer-social-link']: unknown;
      ['rh-footer-universal']: unknown;
      ['rh-footer-copyright']: unknown;
      ['rh-footer-block']: unknown;
      ['rh-cta']: unknown;
    }
  }
}
  ...
  return (
    <rh-footer data-analytics-region="page-footer">
      <a slot="logo" href="https://redhat.com/en" data-analytics-category="Footer" data-analytics-text="Logo">
        <img width="169" height="40" alt="Red Hat logo" src="https://static.redhat.com/libs/redhat/brand-assets/2/corp/logo--on-dark.svg" loading="lazy" />
      </a>
      ...
      <rh-footer-universal slot="universal">
        ...
        <rh-footer-copyright slot="links-secondary">© 2023 Red Hat, Inc.</rh-footer-copyright>
